...
**[editsvgcode.com](https://editsvgcode.com)**

[![](https://editsvgcode.com/screenshots/01-editor-full.png)](https://editsvgcode.com)
...
![Autocomplete](https://editsvgcode.com/screenshots/02-autocomplete.png)

### Hover Documentation
Hover over any SVG element or attribute to see its description from the SVG specification.

![Hover Documentation](https://editsvgcode.com/screenshots/02b-hover-tooltip.png)
...
![Attribute Completion](https://editsvgcode.com/screenshots/03-attribute-completion.png)

### Color Picker
Inline color swatches with a picker supporting hex, RGB, HSL, and named SVG colors.

![Color Picker](https://editsvgcode.com/screenshots/04-color-completion.png)
...
![Cloud Storage](https://editsvgcode.com/screenshots/14-files-page.png)
...
![AI Chat](https://editsvgcode.com/screenshots/08-chat-conversation.png)
...
![Image Generation](https://editsvgcode.com/screenshots/11-image-generation.png)
...
![Image Modification](https://editsvgcode.com/screenshots/16-image-modification.png)

### Model Selector
Switch between AI models from a dropdown. A reasoning effort slider trades speed for quality on complex edits.

![Model Selector](https://editsvgcode.com/screenshots/10-model-selector.png)
...
![Icon Search](https://editsvgcode.com/screenshots/13-icon-picker.png)
