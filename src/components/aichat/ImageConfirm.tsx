  ...
  return (
    <div className="aui-image-confirm">
      ...
      <div className="aui-image-confirm-actions">
        <button className="aui-image-confirm-btn aui-image-confirm-btn-primary" onClick={onConfirm}>Yes, proceed</button>
        <button className="aui-image-confirm-btn" onClick={onDecline}>No, try to draw SVG with code instead</button>
      </div>
    </div>
  );
}
