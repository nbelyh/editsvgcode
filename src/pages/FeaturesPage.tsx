...
const AI_FEATURES: Feature[] = [
  {
    title: 'AI Chat',
    description: 'Type a request like "make the circles red" or "add a drop shadow to all text". The AI reads your current SVG, generates modified code, and shows a diff. You review the changes and accept or reject. Multi-turn conversations work — each message builds on the previous context.',
    ...
    <div className="page-scroll">
      <Container size="lg" py="xl">
        <Stack gap="md">
          ...
          <FeatureSection title="AI Tools (Pro)" features={AI_FEATURES} />
